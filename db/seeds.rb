...
jake = User.create!(username: "jake", password:"777", first_name:"jake", last_name: "Rivera",avatar: "https://image-cdn.hypb.st/https%3A%2F%2Fhypebeast.com%2Fimage%2F2020%2F11%2Fdisney-marvel-deadpool-3-molyneux-sisters-writers-001.jpg?quality=95&w=1170&cbr=1&q=90&fit=max", vaccinated:false,age:27, hometown:"Manhattan")
...
Vent1 = Post.create!( content:"I need help deciding on a name for my APP", img_url:"http://4.bp.blogspot.com/-LQ9xZOrXNE8/VoALGBUKY2I/AAAAAAAARRI/Jagihem1STI/s1600/NeedHelpNaming2.jpg",wall:victorwall)
...
Vent3 = Post.create!( content:"Should i be a software engineer", img_url:"https://www.business.com/images/content/5ca/3e1aa5a215e8a458bb313/1500-0-",wall:victorwall)
...
Vent2 = Post.create!( content:"I need Help choosing an outfit", img_url:"https://previews.123rf.com/images/vadymvdrobot/vadymvdrobot1706/vadymvdrobot170603325/81210620-picture-of-young-woman-standing-in-clothes-shop-indoors-choosing-between-two-dresses-looking-at-came.jpg",wall:victorwall)
...
feedback1 = Feedback.create!(user_id:User.fourth.id,post_id:Post.first.id, comment:"Heyyy i think you should change your greeting to something more professional", pro:false, con:true )
feedback2 = Feedback.create!(user_id:User.fifth.id,post_id:Post.first.id, comment:"Say heyyy to me on Facebook", pro:true, con:false )
feedback3 = Feedback.create!(user_id:User.third.id,post_id:Post.first.id, comment:"Whats cracking home boy", pro:false, con:true )
feedback4 = Feedback.create!(user_id:User.fourth.id,post_id:Post.first.id, comment:"Whats popping", pro:false, con:true )
feedback5 = Feedback.create!(user_id:User.first.id,post_id:Post.first.id, comment:"Heyyyyyyyyyy", pro:true, con:false )
feedback6 = Feedback.create!(user_id:User.first.id,post_id:Post.second.id, comment:"YERRRRRRR", pro:true, con:false )
feedback7 = Feedback.create!(user_id:User.first.id,post_id:Post.second.id, comment:"YER", pro:true, con:false )
feedback8 = Feedback.create!(user_id:User.first.id,post_id:Post.second.id, comment:"YERRRR", pro:true, con:false )
